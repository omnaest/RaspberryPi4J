...
public class WeightServiceImpl implements WeightService
{
    ...
    {
        return new Nau7802ServiceImpl(this.i2cService);
    }

    @Override
    public int readValueFromNau7802(int bus)
    {
        return this.createNau7802Service()
                   .usingBus(bus)
                   .readValue();
    }
    ...
    public class Nau7802ServiceImpl implements Nau7802Service
    {
        ...
        private void selectChannel(Nau7802I2CAccessor accessor)
        {
            ...
            accessor.getChannelSelectBit()
                    .writeValue(0);
            this.waitForRegisterBitToBecomeTrueOrThrowIllegalStateException(1000, TimeUnit.MILLISECONDS, "Unable to select channel",
